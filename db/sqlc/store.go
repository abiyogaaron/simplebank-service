...
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		fmt.Println(txtName, "Create Entry From Account")
		...
		fmt.Println(txtName, "Create Entry To Account")
		...
		fmt.Println(txtName, "Update From Account Balance")
		...
		fmt.Println(txtName, "Update Account to Account Balance")
